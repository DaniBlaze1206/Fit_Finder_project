    ...
    <div style={styles.page}>
        ...
        <Reveal>
          <div style={styles.heroLeft}>
            ...
            <p style={styles.heroSubtitle}>
              Turn your expertise into a business. Build your profile, get discovered by users,
              manage sessions, and grow your client base — with FitFinder’s coach tools.
            </p>
            ...
            <div style={styles.note}>
              Already a coach? After login, you’ll be redirected to your coach dashboard automatically.
            </div>
          </div>
        </Reveal>
          ...
          <div style={styles.heroRight}>
            <div className="card" style={styles.heroCard}>
              ...
              <div style={styles.bulletRow}>
                ...
                <span>Coach profile with specialties, bio, and pricing</span>
              </div>

              <div style={styles.bulletRow}>
                <span style={styles.bulletIcon}>✅</span>
                <span>Client discovery through user search</span>
              </div>

              <div style={styles.bulletRow}>
                <span style={styles.bulletIcon}>✅</span>
                <span>Simple session management (JSON storage for now)</span>
              </div>

              <div style={styles.bulletRow}>
                <span style={styles.bulletIcon}>✅</span>
                <span>Ratings & reviews to build trust</span>
              </div>
      ...
      <section style={styles.featuresSection}>
        <Reveal>
          <div className="card" style={styles.featureCard}>
            ...
            <h3 style={styles.featureTitle}>Build Your Profile</h3>
            <p style={styles.featureText}>
              Highlight your specialties, experience, and training style so users choose you confidently.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal>
          <div className="card" style={styles.featureCard}>
            <div style={styles.featureIcon}>📆</div>
            <h3 style={styles.featureTitle}>Manage Sessions</h3>
            <p style={styles.featureText}>
              Track bookings, manage availability, and keep your schedule organized.
            </p>
          </div>
        </Reveal>
        ...
        <Reveal>
          <div className="card" style={styles.featureCard}>
            <div style={styles.featureIcon}>💬</div>
            <h3 style={styles.featureTitle}>Grow Trust</h3>
            <p style={styles.featureText}>
              Collect reviews, improve ratings, and get more clients through social proof.
            </p>
          </div>
        </Reveal>
      </section>
      ...
      <section style={styles.howSection}>
        ...
        <div style={styles.howGrid}>
          <Reveal>
            <div className="card" style={styles.howCard}>
              ...
              <p style={styles.howText}>
                Create an account. Start as a normal user, then upgrade to coach in your dashboard.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="card" style={styles.howCard}>
              <h3 style={styles.howStep}>2. Set Up Profile</h3>
              <p style={styles.howText}>
                Add your specialties, city, pricing, and availability so users can find you.
              </p>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div className="card" style={styles.howCard}>
              <h3 style={styles.howStep}>3. Coach & Earn</h3>
              <p style={styles.howText}>
                Accept requests, run sessions, and build a sustainable coaching business.
              </p>
            </div>
          </Reveal>
        </div>
      ...
      <section style={styles.ctaSection}>
        <Reveal>
          <div className="card" style={styles.ctaCard}>
            <h2 style={styles.ctaTitle}>Ready to start coaching?</h2>
            <p style={styles.ctaText}>
              Upgrade to a coach account and set up your professional profile in minutes.
            </p>
